...
public class CGCW02{
	...
	class Renderer implements GLEventListener {
		...
		public void display(GLAutoDrawable drawable) {
			...
			T.translate(0, 0.35f, 0);

			//Locate camera
			//T.lookAt(1.0f, 0f, 0f, 0f, 0f, -100f, 0f, 1f, 0f);  	//Default
		...
		public void init(GLAutoDrawable drawable) {
			...
			STorus torus = new STorus(1.0f, 0.25f, 50, 30);
			idPoint = 1;
			idBuffer = 1;
			idElement = 1;
			...
			// Set Torus material
			Vec4 materialAmbient2 = new Vec4(0.0f, 0.5f, 0.0f, 1.0f);   // Green ambient color
			Vec4 materialDiffuse2 = new Vec4(0.4f, 0.7f, 0.2f, 1.0f);   // Green diffuse color
			Vec4 materialSpecular2 = new Vec4(0.0f, 1.0f, 0.0f, 1.0f);  // Green specular color
			materialShininess2 = 100.0f;
