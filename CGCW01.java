...
public class CGCW01{
	...
	class Renderer implements GLEventListener, KeyListener {
		...
		// Variables used to define transformation rates
		private static final float zoom = 1.05f;
		private static final float rotation = 360 / 15f;
		private static final float translation = 0.10f;
